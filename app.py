...
# Hide all Streamlit chrome via a small markdown style injection
st.markdown("""<style>
...
# ---------------------------------------------------------------------------
# Build the phone-frame HTML as a self-contained page rendered via
# components.html() — this uses an iframe so NO Streamlit sanitisation.
# ---------------------------------------------------------------------------
...
if step == 1:
    ...
    <div class="screen">
        ...
        <div class="welcome-card" style="margin-top:0.5rem;">
            ...
            <a class="btn-green-link" href="?step=2" target="_top">
    ...
    <div class="screen">
        <div class="alert-card">
            ...
            <a class="btn-green-link" href="?step=3" target="_top">
    ...
    <div class="screen">
        ...
        <a class="btn-green-link" href="?step=1" target="_top" style="margin-top:auto;">
...
html, body {{ height:100%; width:100%; background:#0F0F10; font-family:'Inter',sans-serif; color:#1C1917; }}
.phone-wrapper {{ display:flex; justify-content:center; align-items:center; min-height:100%; padding:2rem 1rem; }}
.phone-container {{ width:390px; min-height:780px; background:#FDFBF7; border-radius:3rem; box-shadow:0 25px 50px -12px rgba(0,0,0,0.5); overflow-y:auto; position:relative; display:flex; flex-direction:column; }}
...
.btn-green-link {{ width:100%; background:#4A7C59; color:#FFFFFF !important; text-decoration:none; border-radius:1.25rem; padding:1.1rem; font-weight:600; font-size:0.95rem; display:inline-flex; align-items:center; justify-content:center; gap:0.6rem; transition:all 0.2s ease; }}
...
# Render as a self-contained HTML iframe — no Streamlit sanitisation
